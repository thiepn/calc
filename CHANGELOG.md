...
- Fixed a cross-module exactness bug where approximate numerical Worksheet references were reconstructed from decimal text as exact Rationals; approximate values now remain real/approximate through downstream expressions.
