...
const commands=[
  ...
  {id:"u5.jordan",title:"U5: Jordan chains V2",keywords:"advanced linear algebra jordan generalized eigenvectors chains canonical form",run:function(){switchView("calculate");$("#expressionInput").value="jordanv2(2,1,0;0,2,1;0,0,2)".replaceAll(";", "|");previewExpression();$("#expressionInput").focus();}},
