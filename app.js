...
const commands=[
  ...
  {id:"u7.count",title:"U7: Exact combinatorics",keywords:"discrete mathematics combinatorics binomial choose permutations catalan stirling bell",run:function(){switchView("calculate");$("#expressionInput").value="choose(52; 5)";previewExpression();$("#expressionInput").focus();}},
  {id:"u7.modular",title:"U7: Modular arithmetic & CRT",keywords:"discrete number theory modular inverse chinese remainder congruence",run:function(){switchView("calculate");$("#expressionInput").value="crt(2,3; 3,5; 2,7)";previewExpression();$("#expressionInput").focus();}},
  {id:"u7.recurrence",title:"U7: Linear recurrence",keywords:"discrete recurrence sequence generating function fibonacci",run:function(){switchView("calculate");$("#expressionInput").value="linrec(1,1; 0,1; 20)";previewExpression();$("#expressionInput").focus();}},
  {id:"u7.logic",title:"U7: Propositional logic",keywords:"discrete logic truth table implication cnf dnf equivalence",run:function(){switchView("calculate");$("#expressionInput").value="truth((p -> q) & (q -> r))";previewExpression();$("#expressionInput").focus();}},
  {id:"u7.relation",title:"U7: Relations & posets",keywords:"discrete relation equivalence partial order hasse closure",run:function(){switchView("calculate");$("#expressionInput").value="relation(1,2,4; 1>1,2>2,4>4,1>2,1>4,2>4)";previewExpression();$("#expressionInput").focus();}},
  {id:"u7.shortest",title:"U7: Graph shortest path",keywords:"discrete graph dijkstra shortest path weighted graph",run:function(){switchView("calculate");$("#expressionInput").value="shortest(a,b,c,d; a-b:1,b-c:2,a-c:5,c-d:1; a; d)";previewExpression();$("#expressionInput").focus();}},
  {id:"u7.mst",title:"U7: Minimum spanning tree",keywords:"discrete graph kruskal minimum spanning tree mst",run:function(){switchView("calculate");$("#expressionInput").value="mst(a,b,c,d; a-b:1,b-c:2,a-c:5,c-d:1)";previewExpression();$("#expressionInput").focus();}},
  {id:"u7.chromatic",title:"U7: Exact graph coloring",keywords:"discrete graph chromatic number coloring",run:function(){switchView("calculate");$("#expressionInput").value="chromatic(a,b,c; a-b,b-c,c-a)";previewExpression();$("#expressionInput").focus();}},
